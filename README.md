...
[![Version](https://img.shields.io/npm/v/text-to-sql-agent-cli.svg)](https://npmjs.org/package/text-to-sql-agent-cli)
[![Downloads/week](https://img.shields.io/npm/dw/text-to-sql-agent-cli.svg)](https://npmjs.org/package/text-to-sql-agent-cli)
